...
$string['choosereadme'] = '<p>Ella is a theme that allows you to easily customise Moodle\'s look and feel directly from the web interface.</p>
<p>Visit the admin settings to change colours, add an image as a background, add your logo and ella.</p>';

$string['configtitle'] = 'Ella' ;
...
$string['pluginname'] = "Ella's cool theme";
...
$string['h2textcolor'] = 'Secondary header text colour';
$string['h2textcolor_desc'] = "The colour of the secondary headers.";
$string['phovercolor'] = 'Paragraph hover colour';
$string['phovercolor_desc'] = 'The colour of the paragraph hover.';
